...
ActiveRecord::Schema.define(version: 20171006013558) do
  ...
  add_index "comments", ["commentator_id"], name: "index_comments_on_commentator_id"
  ...
  add_index "ownerships", ["blog_id"], name: "index_ownerships_on_blog_id"
